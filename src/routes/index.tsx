...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="currentColor"
      aria-hidden="true"
      className={`h-[20px] w-[20px] shrink-0 ${className ?? ""}`}
    >
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section id="inicio" className="relative overflow-hidden px-3 pt-28 pb-6 sm:px-5 sm:pt-32">
          <BrandTube src={tubeLimeLoop} width={520} top="-90px" right="-170px" rotate={15} variant="hero" />
...
<div
          ...
          <div className="relative overflow-hidden mx-auto max-w-[1400px] rounded-[40px] bg-brand-ink px-5 py-20 text-white sm:px-8 md:py-28">
            ...
            <div className="relative z-10 mx-auto max-w-6xl">
              ...
              <div className="mt-8 flex flex-col gap-6">
                ...
                <Reveal delay={100}>
                  <p className="max-w-3xl text-base leading-relaxed break-words text-white/60 lg:max-w-none lg:whitespace-nowrap">
        ...
        <section id="cowork" className="px-3 sm:px-5">
          <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[40px] bg-brand-lime">
            <BrandTube src={tubeBlueWave} width={560} bottom="-110px" right="-190px" rotate={-14} />
